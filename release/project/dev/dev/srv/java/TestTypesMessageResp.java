...
public class TestTypesMessageResp implements IBotMsgInterface {
	...
	public TestTypesMessageResp() throws Exception {
	...
	public TestTypesMessageResp(OtpErlangTuple msg) throws Exception {
		resultObject = new OtpErlangObject[5];
		this.set_defaultValues();
