...
public class TestTypesMessage implements IBotMsgInterface {
	...
	public TestTypesMessage() throws Exception {
	...
	public TestTypesMessage(OtpErlangTuple msg) throws Exception {
		resultObject = new OtpErlangObject[5];
		this.set_defaultValues();
