...
add_node_to_topic(TopicName, NodeName, ServerName) -> ?DBG_INFO("topic table info: ~p~n", [ets:info(?TABLE_TOPICS)]), ?DBG_INFO("add_node_to_topic -> ~p~n", [[TopicName, NodeName, ServerName]]),
