import sys
from core.BotNode import BotNode
from TestMsg import TestMsg
from py_interface import erl_eventhandler, erl_common
import time
#erlang:send({'BLA_BLA_BLA_CLIENT1_MBox', 'BLA_BLA_BLA_CLIENT1@alex-N550JK'},{"start"}).
class TestNode(BotNode):

    def __init__(self, args):
        argstest = ["BLA_BLA_BLA_CLIENT1", "alex-N550JK", "core@alex-N550JK", "ibot_nodes_srv_connector", "ibot_nodes_srv_topic", "ibot_nodes_srv_service", "jv"]
