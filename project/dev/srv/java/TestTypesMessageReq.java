...
public class TestTypesMessageReq implements IBotMsgInterface {
	...
	public TestTypesMessageReq() throws Exception {
	...
	public TestTypesMessageReq(OtpErlangTuple msg) throws Exception {
		resultObject = new OtpErlangObject[5];
		this.set_defaultValues();
